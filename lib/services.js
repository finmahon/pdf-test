...
var Services = function (host, port) {
  ...
  this.HTMLtoPDF = function (req, res) {
    ...
    console.log('QQQQQ ', JSON.stringify(req.body))
    console.log('QQQQQqqqqqq ', req.body.html)
    ...
    console.log('server 1', server.getURL())
    if (html) {

      page.setContent(html);
      page.patchCSS(cssServer);
      console.log('server 2', server.getURL())
      server.deploy(page.getPage());
      console.log('server 3', server.getURL())
